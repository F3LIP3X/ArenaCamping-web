    ...
    <div className='wrapper'>
      <header>
        ...
        <nav className='headBars'>
          <ul>
            ...
            <li><Link to="/page2#service">Servicio</Link></li>
            <li><Link to="/page2#activities">Actividades</Link></li>
      ...
      <div className="main-content">
        <main>
          <section id="home">
            <h2>¡¡Bienvenido!!</h2>
            <p>¡En Arena Camping puedes disfrutar de la tranquilidad y belleza de la naturaleza en nuestro camping!</p>
          </section>
      ...
      <footer className="footer-page">
        <div className='foot'>
          ...
          <nav className='footertext'>
            <ul>
              <li><Link to="/">Inicio</Link></li>
              <li><Link to="/page2#about">Acerca de</Link></li>
              <li><Link to="/page2#contact">Contacto</Link></li>
            </ul>
          </nav>
        </div>
